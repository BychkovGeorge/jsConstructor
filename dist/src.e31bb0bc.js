...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"assets/pink.jpg":[function(require,module,exports) {
module.exports = "/pink.01da02d6.jpg";
...
function (_Block3) {
  ...
  _createClass(ColumnsBlock, [{
    ...
    value: function toHtml() {
      var styles = this.options.styles;
      var html = this.value.map(function (el) {
        return (0, _utils.col)(el, (0, _utils.css)(styles));
      }).join('');
...
function (_Block4) {
  ...
  _createClass(ImageBlock, [{
    ...
    value: function toHtml() {
      ...
      return (0, _utils.row)("<img src=\"".concat(this.value, "\" style=\"").concat((0, _utils.css)(imageStyles), "\" />"), (0, _utils.css)(styles));
    }
  }]);
...
var _pink = _interopRequireDefault(require("./assets/pink.jpg"));
...
}), new _blocks.TextBlock('Ниже расположены колонки с дополнительной информацией', {
  styles: {
    background: 'linear-gradient(to right, #ff0099, #493240)',
    color: '#fff',
    'text-align': 'center'
  }
}), new _blocks.ColumnsBlock(['В колонке может быть такой текст', 'Или например такой', 'А ешё вот такой', 'Ну в общем я думаю суть вы уловили :)'], {
  styles: {
    color: '#ff0099',
    'text-align': 'center',
    'font-weight': 1000,
...
}), new _blocks.TextBlock('А ещё ниже расположена какая-то фотография...', {
  styles: {
    background: 'linear-gradient(to right, #ff0099, #493240)',
    color: '#fff',
    'text-align': 'center'
  }
}), new _blocks.ImageBlock(_pink.default, {
  styles: {
...
exports.model = model;
},{"./assets/pink.jpg":"assets/pink.jpg","./classes/blocks":"classes/blocks.js"}],"../node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
